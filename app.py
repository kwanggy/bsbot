...
def users():
    ...
    for a_user in users:
        ret += a_user.lolname
        ret += '\tlolid: ' + str(a_user.lolid)
        ret += '\ttwtid: ' + str(a_user.twtid)
        ret += '\tlastgame: ' + str(a_user.lastgame)
        ret += '\toffense: ' + str(a_user.offense)
        ret += '\tactive: ' + str(a_user.active)
        ret += '\tactive_since: ' + str(a_user.active_since)
        ret += '\tlive_since: ' + str(a_user.live_since)
        ret += '\tregCode: ' + a_user.regCode
        ret += '\n'
